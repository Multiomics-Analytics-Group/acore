...
def run_ssgsea(data, annotation, annotation_col='an notation', identifier_col='identifier', set_index=[], outdir='tmp', min_size=15, max_size=500, scale=False, permutations=0):
    """
